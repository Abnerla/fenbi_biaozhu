...
### 隐私承诺
粉笔标注是一款完全离线运行的应用，不包含任何网络请求代码，不收集用户数据，不上传任何信息到云端或第三方服务器。应用请求的所有权限都仅用于本地功能实现，没有任何隐私风险。
...
### 开源透明
粉笔标注是一个完全开源的项目，所有源代码都托管在GitHub上，任何人都可以查看、审计、修改代码。开源确保了应用的透明性和安全性，用户可以完全信任应用不会做出任何恶意行为。
...
#### 从GitHub下载（推荐）
访问项目的[Releases页面](../../releases)，下载最新版本的APK文件。每个版本都包含详细的更新说明，建议下载标记为"Latest"的最新稳定版本。

#### 从源码构建
如果你是开发者，可以克隆项目源码自行编译：
1. 安装Android Studio Hedgehog (2023.1.1) 或更高版本
2. 克隆项目：`git clone https://github.com/yourusername/annotation.git`
3. 打开项目，等待Gradle同步完成
4. 连接Android设备或启动模拟器
...
#### 报告问题
发现了bug或有功能建议？在[Issues页面](../../issues)提交问题。好的问题报告应该包含：
- 清晰的问题标题（用一句话概括问题）
- 详细的问题描述（说明问题的现象和影响）
- 设备信息（设备型号、Android版本、应用版本）
- 复现步骤（如何触发这个问题）
- 期望行为（你认为应该是什么样的）
- 实际行为（实际发生了什么）
- 截图或日志（如果有的话）
...
#### 提交代码
想要修复bug或添加新功能？按以下步骤操作：
1. Fork本仓库到你的GitHub账号
2. Clone你的Fork到本地：`git clone https://github.com/your-username/annotation.git`
...
7. 在GitHub上创建Pull Request，详细描述你的更改

#### 改进文档
文档和代码同样重要。如果你发现文档中的错误、不清楚的说明或缺失的内容，欢迎提交PR改进文档。好的文档能帮助更多人使用和贡献项目。


### 贡献指南

**代码规范**
- 使用Kotlin编写代码，遵循Kotlin官方编码规范
- 使用有意义的变量名和函数名，添加必要的注释
- 保持代码简洁清晰，避免过度复杂的逻辑
- 遵循项目现有的代码风格和结构

**提交规范**
- 提交信息使用中文或英文，清楚描述修改内容
- 每次提交只做一件事，不要在一次提交中混合多个不相关的修改
- 提交前使用`./gradlew test`运行测试，确保没有破坏现有功能

**Pull Request规范**
- PR标题清晰说明修改内容
- PR描述详细说明修改的原因、方案和影响
- 如果是修复bug，在描述中引用对应的Issue
- 保持PR规模适中，大型功能可以拆分为多个PR
...
### 项目主页
[GitHub仓库](https://github.com/1444170707/annotation)


### 邮件联系
1444170707@example.com
